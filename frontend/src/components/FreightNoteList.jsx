...
function FreightNoteList() {
  ...
  const printReceipt = (noteData) => {
    try {
      ...
      // Formatar datas com fuso de Manaus ANTES do template
      const issueDate = formatDateBR(noteData.issueDate || noteData.createdAt);
      const cancelDate = noteData.canceledAt ? formatDateBR(noteData.canceledAt) : '';
      const paymentDate = noteData.paymentDate ? formatDateBR(noteData.paymentDate) : '';
          ...
          <body>
            <div class="receipt">
              ...
              <div class="header">
                ...
                <div class="info-line">
                  <span>Cancelada em: ${formatDateBR(noteData.canceledAt)}</span>
                </div>` : ''}
              </div>
              ...
              <div class="payment-info">
                ...
                <div class="total-line">
                  <span>DATA:</span>
                  <span><strong>${formatDateBR(noteData.paymentDate)}</strong></span>
                </div>` : ''}
              </div>
              ` : `
              <div class="payment-info">
